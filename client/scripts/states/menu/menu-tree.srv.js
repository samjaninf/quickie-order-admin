(function() {
    angular.module('quickie')
        .factory('MenuTree', MenuTree);

    MenuTree.$inject = [];

    function MenuTree() {

        // @link https://github.com/joaonuno/tree-model-js/blob/master/index.js

        // Tree.prototype.parse should be Tree.prototype.format because it takes a $modelValue
        // and converts it to a $viewValue.
        ...
        Tree.prototype.parse = function(model) {
